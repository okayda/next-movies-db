        ...
        {data.map((genre: any, i: number) => (
          <Link key={genre.id} href="/">
            <FadeDiv
              index={i}
              duration={0.5}
              className="genre-card s:before:h-[400px] s:before:w-[400px] relative h-[240px] rounded-lg border  border-[#373737] before:h-[600px] before:w-[600px] xxs:h-[150px] xxs:before:h-[340px] xxs:before:w-[340px] xs:before:h-[380px] xs:before:w-[380px] sm:h-[180px] md:h-[200px]"
            >
